...
AOIWorld::AOIWorld(int _x_begin, int _x_end, int _x_count, int _y_begin, int _y_end, int _y_count): \
    x_begin(_x_begin),x_end(_x_end),x_count(_x_count),y_begin(_y_begin),y_end(_y_end),y_count(_y_count)
{
    //网格宽度
